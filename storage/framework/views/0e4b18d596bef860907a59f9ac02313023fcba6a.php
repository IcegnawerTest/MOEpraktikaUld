        ...
        <p class="img">
            <img style="max-width: 500px; max-height: 500px" src="<?php echo e($product->img); ?>" alt="Изображение отсутствует">
        </p>
        <p class="description">
            Описание: <?php echo e($product->description); ?>

        </p>
        <p class="coordinates">
           Состав: <?php echo e($product->composition); ?>
...
<?php echo $__env->make('pattern.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OSPanel\domains\BakeryUld\resources\views/detail.blade.php ENDPATH**/ ?>